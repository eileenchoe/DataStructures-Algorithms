...
public class Yarn implements YarnInterface {
    ...
    // >> [AF] Don't include a main method in your submission; what would
    // happen if someone imported your class for use in their own
    // main method?!
    ...
    // >> [AF] A little inefficient adding / removing items by occurrence,
    // rather than by Entry (see solution)
    ...
    // >> [AF] Simpler way to do this (see solution)
